...
const ContactList = ({ contacts, onSetContacts, mod, setPerson, setAddRefactorState }) => {
  ...
  return (
      <table>
        ...
        <tbody>
        {
          contacts.map((contact, i) => <Contact setAddRefactorState={setAddRefactorState} onsetContacts={onSetContacts} setPerson={setPerson} mod={mod} onToggleContactFromList={toggleContactFromList} checkedIds={checkedIds} contactData={contact} key={`contact-${i}`} />)
        }
